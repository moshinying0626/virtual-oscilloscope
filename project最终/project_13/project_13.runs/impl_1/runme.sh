...
HD_PWD='C:/project_13/project_13.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_13.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_13.tcl -notrace
